...
class PersistentStore {
	...
	final protected MachineSnapshotTableExtend MACHINE_SNAPSHOT_TABLE;
	...
	public PersistentStore( final DataAdaptor storeAdaptor ) {
		...
		MACHINE_SNAPSHOT_TABLE = new MachineSnapshotTableExtend( tableConfigurations.get( "MachineSnapshot" ) );
