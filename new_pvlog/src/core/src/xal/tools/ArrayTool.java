...
public class ArrayTool {
	 ...
	 */
	protected static Object getBaseArray(Object array, int[] indices,
			int indexPtr) {
	 ...
	 * 
	 * @param indices
	 *            the indices are the set of indices to increment
	 * @param dimensions
	 *            each element is the size of each dimension
	...
	static public double[] getDoubleArrayFromString(final String douString) {
